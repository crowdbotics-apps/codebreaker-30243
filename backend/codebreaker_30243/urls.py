"""codebreaker_30243 URL Configuration
...
admin.site.site_header = "Codebreaker"
admin.site.site_title = "Codebreaker Admin Portal"
admin.site.index_title = "Codebreaker Admin"

# swagger
api_info = openapi.Info(
    title="Codebreaker API",
    default_version="v1",
    description="API documentation for Codebreaker App",
)
